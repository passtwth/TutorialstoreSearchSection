...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func customizeAppearance() {
        ...
        UISearchBar.appearance().barTintColor = UIColor(red: 10/255, green: 80/255, blue: 80/255, alpha: 1)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Tutorial_storeSearchSection")
